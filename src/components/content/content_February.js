...
import Food_recipe_February from "./food_recipe/food_recipe_February";
import Footer from "./footer/footer";
import $ from 'jquery'

class Content_February extends Component {
    constructor(props) {
      super(props)
      this.initState = {
        id:'',
...
export default Content_February;
