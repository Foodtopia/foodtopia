...
import Food_recipe_September from "./food_recipe/food_recipe_September";
import Footer from "./footer/footer";
import $ from 'jquery'

class Content_September extends Component {
    constructor(props) {
      super(props)
      this.initState = {
        id:'',
...
export default Content_September;
