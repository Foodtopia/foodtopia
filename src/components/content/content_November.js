...
import Food_recipe_November from "./food_recipe/food_recipe_November";
import Footer from "./footer/footer";
import $ from 'jquery'

class Content_November extends Component {
    constructor(props) {
      super(props)
      this.initState = {
        id:'',
...
export default Content_November;
