...
import Food_recipe_December from "./food_recipe/food_recipe_December";
import Footer from "./footer/footer";
import $ from 'jquery'

class Content_December extends Component {
    constructor(props) {
      super(props)
      this.initState = {
        id:'',
...
export default Content_December;
